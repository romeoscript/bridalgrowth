        ...
        <div className='relative w-5/5  mt-[75px] ' style={{ height: 'calc(80vh - 80px)' }}>
            ...
            <div className='font-crimson absolute top-0 left-0 w-full h-full bg-[#010814cc] flex flex-col justify-center items-center text-white'>
                <div className='w-3/5 m-auto text-center'>
                    <h2 className='text-6xl'>Boosting Business Revenue with SEO & Email Marketing Strategies</h2>
                    <p className='text-2xl w-4/5 m-auto p-[1rem] my-[1rem]'>Lorem ipsum dolor sit amet consectetur. Viverra nec ultrices enim in elit ac volutpat. Justo aliquet leo mauris</p>
